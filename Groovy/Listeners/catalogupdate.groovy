package com.listeners.Customlisteners
...
if(issueType.name=="HR Services Catalog Task" ||issueType.name== "Generic Service Request Catalog Task" || 
   issueType.name== "Facilities Service Catalog Task" || issueType.name== "Security Service Catalog Task" || 
   issueType.name== "Software Service Catalog Task" || issueType.name== "Hardware Service Catalog Task" ||
   issueType.name == "Offboarding Subtask" || issueType.name == "Legal Hold Data Update" || issueType.name == "Role Based Access Subtask" || issueType.name == "Infra Services Catalog Okta Sub-Task" || issueType.name == "JiraET Services Subtask") 
{
