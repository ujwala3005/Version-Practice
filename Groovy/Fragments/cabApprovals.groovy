...
boolean isInIssueType = issue.issueType.name in ["Normal Change Request", "Emergency Change Request"]
...
boolean result = issue.projectObject.name == "IT" && isInIssueType && cabApprovalsPresent
result
